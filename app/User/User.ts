    ...
    apply(client: Client, msg: MESSAGE_FOR_SERVER) {
        switch (msg.type) {
            ...
            case "SERVER_UPDATE_LIST_DATA":
                console.log(">>>> INFO:SERVER_UPDATE_LIST_DATA ");
            ...
            case "SERVER_UPDATE_ITEM_LABEL":
                console.log(">>>> INFO:SERVER_UPDATE_ITEM_LABEL ");
